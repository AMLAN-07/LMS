      ...
      <div className="space-y-6 min-w-[1200px]">
        ...
        <div className="flex items-center justify-center rounded-3xl border border-zinc-700 bg-[#252525] h-64">
          <div className="text-center">
            <svg
              className="mx-auto size-40 mb-4 text-zinc-400"
            ...
            <h2 className="text-3xl font-semibold text-zinc-100">Dashboard</h2>
...
=======
            <div className="rounded-3xl border border-zinc-700 bg-[#252525] p-6">
              ...
              <h3 className="mt-2 text-4xl font-bold text-white">120</h3>
            </div>

            <div className="rounded-3xl border border-zinc-700 bg-[#252525] p-6">
              <svg
                className="mb-4 size-70 text-green-400"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
              ...
              <h3 className="mt-2 text-4xl font-bold text-white">850</h3>
            </div>

            <div className="rounded-3xl border border-zinc-700 bg-[#252525] p-6">
              <svg
                className="mb-4 size-70 text-yellow-400"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
...
>>>>>>> a5db1ff (update both frontned and backend)
              ...
              <p className="text-zinc-400">Borrow Records</p>
...
=======
              <h3 className="mt-2 text-4xl font-bold text-white">52</h3>
            </div>

            <div className="rounded-3xl border border-zinc-700 bg-[#252525] p-6">
              <svg
                className="mb-4 size-70 text-purple-400"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
              ...
              <h3 className="mt-2 text-4xl font-bold text-white">24</h3>
>>>>>>> a5db1ff (update both frontned and backend)
            </div>
          </div>
        </div>
...
>>>>>>> a5db1ff (update both frontned and backend)
            ...
            <h2 className="text-3xl font-semibold text-zinc-100">Widgets</h2>
...
=======
          <div className="space-y-4">
            {Array.from({ length: 10 }).map((_, index) => (
              <div
                key={index}
                className="flex items-center justify-between rounded-xl bg-zinc-800 px-5 py-4"
              >
                <span className="text-zinc-300">
                  Student #{index + 1} borrowed a book
                </span>
