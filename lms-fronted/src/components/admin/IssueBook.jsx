...
function IssueBook({ form, setForm, onSubmit, students, books, issues, onReturn }) {
    ...
    <div className="page-grid">
      <form className="panel form-grid" onSubmit={onSubmit}>
        ...
        <select required value={form.studentId} onChange={(e) => setForm({ ...form, studentId: e.target.value })}>
          ...
          {activeStudents.map((student) => <option key={student.id} value={student.id}>{student.firstName} {student.lastName} - {student.organizationName || ORGANIZATION_NAME}</option>)}
        </select>
      ...
      <IssueTable issues={issues} students={students} onReturn={onReturn} />
    </div>
  )
}
