    ...
    return (
        ...
        <div className="bg-[#1c1c1c] min-h-screen p-8 text-white">
            ...
            <div className="mb-4 flex items-center justify-between">
                <h2 className='text-xl font-semibold'>List of Student</h2>

                <button
                    type="button"
                    className="flex items-center justify-center gap-2 rounded-xl border border-zinc-700 px-5 py-3 hover:bg-zinc-800 transition"
                    onClick={addStudent}
                >
                            ...
                            student.map((student) => {
                                ...
                                return (
                                    <tr key={student.id}
                                        ...
                                        <td className='px-6 py-6 text-zinc-300 text-lg'>{student.regdNo}</td>
                                        <td>
